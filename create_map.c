...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/14 15:12:36 by skrairab          #+#    #+#             */
/*   Updated: 2023/02/14 15:30:45 by skrairab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**ft_create_tmpmap(char *av, t_game *game)
{
	...
	game->map.tmp_map = malloc(sizeof(char *) * (game->dim.size.y + 1));
